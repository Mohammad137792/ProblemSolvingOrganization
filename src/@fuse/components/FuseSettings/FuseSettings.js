...
import translate from "../../../app/main/helpers/translate";
    ...
    const LayoutSelect = () => {
        return (
            <FormControl component="fieldset" className={classes.formControl}>
                ...
                <FormLabel component="legend" className="text-14">{translate("Style")}</FormLabel>
        ...
        <div className={classes.root}>
            ...
            <div className={classes.formGroup}>
                ...
                <Typography className="my-16 text-12 italic" color="textSecondary">
                    *{translate("Not all option combinations are available")}
                </Typography>
            ...
            <div className={clsx(classes.formGroup, "pb-16")}>
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" className="text-14">{translate("Main")}</FormLabel>
                    <ThemeSelect value={settings.theme.main} name="theme.main" handleChange={handleChange}/>
                </FormControl>
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" className="text-14">{translate("Navbar")}</FormLabel>
                    <ThemeSelect value={settings.theme.navbar} name="theme.navbar" handleChange={handleChange}/>
                </FormControl>
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" className="text-14">{translate("Toolbar")}</FormLabel>
                    <ThemeSelect value={settings.theme.toolbar} name="theme.toolbar" handleChange={handleChange}/>
                </FormControl>
                <FormControl component="fieldset" className={classes.formControl}>
                    <FormLabel component="legend" className="text-14">{translate("Footer")}</FormLabel>
                    <ThemeSelect value={settings.theme.footer} name="theme.footer" handleChange={handleChange}/>
                </FormControl>
            </div>

            <FormControl component="fieldset" className={classes.formControl}>
                <FormLabel component="legend" className="text-14">{translate("Custom Scrollbars")}</FormLabel>
                <Switch
