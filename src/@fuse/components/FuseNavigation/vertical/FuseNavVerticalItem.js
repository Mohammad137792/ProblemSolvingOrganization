...
function FuseNavVerticalItem(props) {
    ...
    const listItemPadding = nestedLevel > 0 ? 'ltr:pl-' + (paddingValue > 80 ? 80 : paddingValue) + " rtl:pr-" + (paddingValue > 80 ? 80 : paddingValue) : 'ltr:pl-24 rtl:pr-24';
    ...
    return (
        ...
        >
            {item.icon && (
                <Icon className="list-item-icon text-16 flex-shrink-0 ltr:mr-16 rtl:ml-16" color="action">{item.icon}</Icon>
            )}
