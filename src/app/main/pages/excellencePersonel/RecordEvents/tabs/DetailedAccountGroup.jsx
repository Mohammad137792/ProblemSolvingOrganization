...
export default function DetailedAccount({scrollTop}) {
    ...
    const formStructure = [{
        ...
        label   : "میزان رسیدن به اهداف برنامه",
        type    : "number",
        
    },{
        name    : "parentAccountId",
        label   : "میزان رضایت مسئول از کلیت برنامه",
        type    : "number",
        
    },{
        name    : "parentAccountId",
        label   : "میزان تناسب برنامه با اهداف تعریف شده",
        type    : "number",
        
    },{
        name    : "parentAccountId",
        label   : "پیشنهادات اجرایی برای برنامه های بعدی",
        type    : "text",
        col     :6, 
    }]
