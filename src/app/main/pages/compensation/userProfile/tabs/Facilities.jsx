...
export default function Facilities({scrollTop}) {
    ...
    function create_object() {
        ...
        dispatch(setAlertContent(ALERT_TYPES.SUCCESS, "امکانات با موفقیت اضافه شد."))
        // }).catch(()=>{
    ...
    function update_object() {
        ...
        set_action(defaultAction)
        set_formValues(formDefaultValues)
        dispatch(setAlertContent(ALERT_TYPES.SUCCESS, "ویرایش امکانات با موفقیت انجام شد."))
        // }).catch(()=>{
        //     dispatch(setAlertContent(ALERT_TYPES.ERROR, 'خطا در ثبت اطلاعات!'));
        // })
    }
