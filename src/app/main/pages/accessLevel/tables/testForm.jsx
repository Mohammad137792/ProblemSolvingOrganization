...
function CreateInput({ valueObject = {}, setRows , rowss,...input }) {
    ...
    function setValue(newValue) {
        ...
        if (input.isParent && input?.rowDatas) {

            
        }else{


            // console.log('CreateInput input', input)
    ...
    function handler_cjeck(e) {
        setValue(e.target.checked)
        console.log("adkvavkjadvjadva")

        if (input.isParent && input?.rowDatas) {



            console.log('CreateInput Prowss', input?.rowss[input?.rowDatas.artifactGroupId])

            console.log('CreateInput ProwDatas', input?.rowDatas)

            console.log('CreateInput Pinput', input)

        } else {
            if (!input.isParent && input?.rowDatas && input?.rowss) {

                console.log('CreateInput rowss', input?.rowss[input?.rowDatas.artifactGroupId])

                console.log('CreateInput rowDatas', input?.rowDatas)
