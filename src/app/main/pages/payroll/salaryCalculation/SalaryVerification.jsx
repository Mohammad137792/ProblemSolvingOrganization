...
export default function SalaryVerification({formVariables, submitCallback, taskId}) {
    ...
    const tabs = [{
        ...
        label: "اطلاعات پرداخت حقوق و دستمزد",
        panel: <PaymentAccount rows={outputs} {...tabsProps}/>
    },{
        label: "بیمه و معوقات",
        panel: <SettingsInsurance rows={dataList.list} {...tabsProps}/>
    },{
        label: "مالیات",
        panel: <SettingsTaxation  setRows={set_actions} {...tabsProps}/>
    }]
        ...
        <React.Fragment>
            ...
            <Card >
                ...
                <CardContent>
                    ...
                    <Box mt={2}>
                        <ActionBox>
                            <Button role="primary" disabled={waiting} onClick={()=>{handle_accept("accepted")}} endIcon={waiting==="accept"?<CircularProgress size={20}/>:null}>
                                تایید
                            </Button>
                            <Button role="secondary" disabled={waiting} onClick={()=>{handle_accept("modify")}} >
                                اصلاح
                            </Button>
                            <Button role="secondary" disabled={waiting} onClick={()=>{handle_accept("rejected")}} endIcon={waiting==="cancel"?<CircularProgress size={20}/>:null} >
                                رد فرآیند
                            </Button>
                        </ActionBox>
                    </Box>
