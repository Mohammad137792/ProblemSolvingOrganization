...
import SalaryCalculationProcess from "./SalaryCalculationProcess";
...
export default function SalaryCalculation({stepName,processFormVariables,taskId,submitCallback,scrollTop}) {
    ...
    return (
        <SalaryCalculationProcess stepName={step} taskId={taskId} formVariables={formVariables} submitCallback={submitCallback} goToStep={goToStep} set_formVariables={set_formVariables} scrollTop={scrollTop}/>
    )
}
