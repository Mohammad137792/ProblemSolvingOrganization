...
export default function WorkingFactorsForm() {
    ...
    const formStructure2 = [
        ...
        },
        {
            ...
            type: "multiselect",
            // filterOptions: options => options.filter(o => formValues2.verificationType == o.excProgPerfId) ,
            options: fieldsData?.verificationAction,
            optionLabelField: "description",
            optionIdField: "enumId",
            filterOptions: options => formValues2["verificationType"] == "progAccept" ? options.filter(o => o.parentEnumId == "EvaProgram") : formValues2["verificationType"] == "suggAccept" ? options.filter(o => o.parentEnumId == "EvaSuggestion") : options,
            required:true,
            disabled: !formValues2?.verificationType || formValues2?.verificationType==="" ,
    ...
    const formStructure = [
        ...
        },
        {
            name: "familyMemberEnumId",
            label: " نحوه ثبت نام ",
            disabled: !formValues.enrollmentAbility || formValues.enrollmentAbility == false ,
