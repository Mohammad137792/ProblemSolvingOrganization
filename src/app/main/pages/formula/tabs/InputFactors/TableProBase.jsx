...
import {getDescription} from "../../../../components/formControls/FormInputSelect";
...
class TableProBase extends React.Component {
    ...
    static propTypes = {
        ...
        setFileInfo :   PropTypes.arrayOf(PropTypes.object),
    ...
    ActionGroup = ()=>{
        const {classes, columns, rows , setFileInfo } = this.props;
        ...
        React.useEffect(()=>{
            console.log("setFileInfo" , setFileInfo);
            if(inputRef?.current?.files[0]  ){
                // && inputRef?.current?.files[0]?.name == setFileInfo?.name && inputRef?.current?.files[0]?.size == setFileInfo?.size
                ...
                {this.props.hiddenHeader == false && (
                    <ToggleButtonGroup size="small" className={classes.marginEnd}>
                            <input
                                ...
                                style={{display: "none"}}
                            />
                        <Tooltip title="آپلود فایل اکسل">
                            <ToggleButton size={"small"}>
                                <CloudUpload  onClick={handleClick}>
                                </CloudUpload>
                            </ToggleButton>
                        </Tooltip>
                    </ToggleButtonGroup>
