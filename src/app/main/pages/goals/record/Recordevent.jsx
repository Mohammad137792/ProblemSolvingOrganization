   ...
   const [SelectGroupingevent,SetSelectGroupingeventId]=useState([
    ...
    const formStructure = [
        ...
        const formStructure1 = [
            ...
            const tableCols = [
                {
                    name    : "event",label   : "موضوع واقعه حساس",type    : "text",},
                    { name    : "Typeofevent",label   : "نوع واقعه",type    : "select",options :SelectTypeofevent,optionLabelField :"ُSelectTypeofevent",optionIdField:"ُSelectTypeofeventId"}
                ,{
                    name    : "Groupingevent",label   : "دسته بندی وقایع",type    : "select",options :SelectGroupingevent,
                    optionLabelField :"SelectGroupingevent",
                    optionIdField:"SelectGroupingeventId"
                },{
                    name:   "dateofevent",
