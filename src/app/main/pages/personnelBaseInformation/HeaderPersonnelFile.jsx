...
import progile from "../../components/sample_avatar.png"

const HeaderPersonnelFile = ({  relationshipType }) => {
    ...
    React.useEffect(() => {
        ...
        axios.get(SERVER_URL + "/rest/s1/fadak/entity/PartyRelationship?partyRelationshipId=" + partyRelationshipId, axiosKey).then(res => {
            setSudoId(res.data?.result[0]?.pseudoId)
        })
                                ...
                                onClick={() => {
                                    if (typeof formData.partyContents == 'undefined') {
                                        ...
                                        if (typeof partyPerson13.partyContentTypeEnumId != 'undefined') {
                                            axios.delete(SERVER_URL + "/rest/s1/fadak/entity/PartyContent?partyContentId=" + partyPerson13.partyContentId, {
                                                headers: {
                                                    'api_key': localStorage.getItem('api_key')
                                                },
                                            })
