...
const ModalDelete = props => {
    ...
    const deleteRow = (id, setTableContent, partyId) => {
        ...
        const putData = {contactMechId : id , partyId : partyId , fromDate : fromDate , thruDate : Date.now()}
        ...
        >
            <div style={modalStyle} className={classes.paper}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <Button variant="outlined" style={{ backgroundColor: "red" }} size="small" onClick={() => { deleteRow(props.id, props.setTableContent, props.partyId) }}  >
                        حذف
                    </Button>
                </div>
